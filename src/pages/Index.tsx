    ...
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p 
            className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto mb-10 animate-fade-in-up stagger-1 leading-relaxed" 
            style={{ opacity: 0 }}
          >
          ...
          >
            <button 
              ...
              className="group inline-flex items-center gap-3 bg-white text-primary px-8 py-4 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-white/20"
            >
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center gap-4">
              ...
              {profile.total_quests_completed > 0 && (
                <Link 
                  to="/quests"
                  className="flex items-center gap-2 px-5 py-2.5 bg-np-gold/10 text-np-gold rounded-full font-medium hover:bg-np-gold/20 transition-colors animate-fade-in border border-np-gold/20"
                >
              ...
              <Link 
                to="/quests"
                className="flex items-center gap-2 px-5 py-2.5 bg-primary/10 text-primary rounded-full font-medium hover:bg-primary/20 transition-colors animate-fade-in border border-primary/20"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Link
                key={feature.title}
                to={feature.to}
                className="group relative bg-card rounded-2xl overflow-hidden border border-border hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 animate-fade-in-up"
